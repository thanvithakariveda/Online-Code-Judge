    ...
    <Layout showSidebar={false}>
      <section className="max-w-4xl mx-auto text-center py-16 sm:py-24 animate-slide-up">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link to="/problems" className="gradient-btn">Browse Problems</Link>
          <Link to="/register" className="px-6 py-2.5 rounded-lg border border-white/20 hover:bg-white/5 transition">
            Get Started
          </Link>
        </div>
